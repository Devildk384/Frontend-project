    ...
    <div className="app">
       ...
       <div className="app__left">
        <div className="app__left-user">
           <Avatar style={{height:"100px" , width :"100px", marginLeft:"100px"}}/>
           <h3> Gulam </h3>
        ...
        <div className="app__left-userlist">
          <ul>
            <li>  <a href="/"> <DashboardIcon style={{marginRight:"30px",color:"black"}}/> Dashboard</a> </li>
            <li>  <a href="/"> <AccountBalanceWalletIcon style={{marginRight:"30px", color:"black"}}/> My Wallet</a></li>
            <li> <a href="/">  <MoneyIcon style={{marginRight:"30px",color:"black"}}/>  Transaction</a></li>
            <li>  <a href="/"> <MonetizationOnIcon style={{marginRight:"30px", color:"black"}} />  Crypto</a></li>
            <li> <a href="/"> <ImportExportIcon style={{marginRight:"30px" , color:"black"}}/>  Exchange</a></li>
            <li>  <a href="/"> <SettingsIcon style={{marginRight:"30px", color:"black"}} /> Setting</a></li>
          </ul>
        </div>
